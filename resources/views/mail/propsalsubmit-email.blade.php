...
<body class='is-responsive'>
  <div class='container'>
    <div class='box'>
      ...
      <p class="bg-gray">{{$user->username}} sent proposal on your job <a href="https://localhost:8000/job-detail/.{{$job->job_id}}">{{$job->job_title}}</a>. Please click <a href="https://localhost:8000/proposals">here</a> to view the proposal.</p>
      <br>
      <!-- <center>
