...
<div class="row">
        ...
        <div class="row">
          ...
          <div class="col-sm-8">
            <div class="pt-4">
              <div class="row">
                <div class="col-6">
                  <h5 class="font-size-15">{{ App\Models\Job::jobCount() }}</h5>
                  <p class="text-muted mb-0">Projects</p>
                </div>
                <div class="col-6">
                  <h5 class="font-size-15">${{ App\Models\Transaction::totalFee() }}</h5>
  ...
  <div class="col-xl-8">
    <div class="row">
      ...
      @slot('title') Project Amount  @endslot
      @slot('price') ${{ App\Models\Transaction::totalAmount() }}  @endslot
      @slot('icon') bx bx-archive-in font-size-24  @endslot
      @endcomponent
      @component('admin.common-components.index-widget')
      @slot('title') Revenue  @endslot
      @slot('price') ${{ App\Models\Transaction::totalFee() }}  @endslot
      @slot('icon') bx bx-archive-in font-size-24  @endslot
      @endcomponent
      @component('admin.common-components.index-widget')
      @slot('title') Average Price  @endslot
      @slot('price') ${{ round(App\Models\Transaction::avgAmount(), 2) }}  @endslot
          ...
          <table class="table table-centered table-nowrap">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="javascript: void(0);" class="text-body font-weight-bold">{{$trans->trans_id}}</a> </td>
                <td>{{ App\Models\Job::client($trans->user_id)->first_name }} {{ App\Models\Job::client($trans->user_id)->last_name }}</td>
                <td>
                  {{date('d F,Y',strtotime($trans->created_at))}}
                </td>
                <td>
                  {{$trans->gross_amt}}
                </td>
                ...
                <td>
                  <i class="fab fa-cc-mastercard mr-1"></i> Paypal
                </td>
              </tr>
              @endforeach
            </tbody>
