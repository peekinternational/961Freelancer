							...
							<div class="wt-dashboardbox wt-dashboardtabsholder">
								...
								<div class="wt-dashboardtabs">
									<ul class="wt-tabstitle nav mb-3" id="pills-tab" role="tablist">
									  ...
									  <li class="nav-item" role="presentation">
									    <a class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">Projects &amp; Awards</a>
									  </li>
									</ul>
								</div>
								  					...
								  					<div class="form-group">
								  						<ul class="wt-attachfile wt-attachfilevtwo">
								  							...
								  							<li class="wt-uploadingholder wt-companyimg-user">
								  								<div class="wt-uploadingbox">
								  									<figure><img src="{{asset('assets/images/company/img-08.jpg')}}" alt="img description"></figure>
								  									<div class="wt-uploadingbar wt-uploading">
								  										<span class="uploadprogressbar"></span>
								  										<span>Profile Photo.jpg</span>
								  										<em>File size: 300 kb<a href="javascript:void(0);" class="lnr lnr-cross"></a></em>
								  							...
								  							<li class="wt-uploadingholder">
								  								<div class="wt-uploadingbox">
								  									<div class="wt-designimg">
								  										...
								  										<label for="demoz"><img src="{{asset('assets/images/company/img-09.jpg')}}" alt="img description"><i class="fa fa-check"></i></label>
								  									</div>
								  									<div class="wt-uploadingbar wt-uploading">
								  										<span class="uploadprogressbar"></span>
								  										<span>Profile Photo.jpg</span>
								  							...
								  							<li class="wt-uploadingholder">
								  								<div class="wt-uploadingbox">
								  									<div class="wt-designimg">
								  										...
								  										<label for="demoq"><img src="{{asset('assets/images/company/img-10.jpg')}}" alt="img description"><i class="fa fa-check"></i></label>
								  									</div>
								  				...
								  				<ul class="sortable list">
								  					<li>
								  						...
								  						<div class="wt-rightarea">
								  							<a href="javascript:void(0);" class="wt-addinfo"><i class="fal fa-pencil"></i></a>
								  							<a href="javascript:void(0);" class="wt-deleteinfo"><i class="fal fa-trash-alt"></i></a>
								  						</div>
								  					</li>
								  					<li>
								  		...
								  		<ul class="wt-experienceaccordion accordion">
								  			<li>
								  				<div class="wt-accordioninnertitle">
								  					...
								  					<div class="wt-rightarea">
								  						<a href="javascript:void(0);" class="wt-addinfo wt-skillsaddinfo" id="accordioninnertitle" data-toggle="collapse" data-target="#innertitle" aria-expanded="true"><i class="fal fa-pencil"></i></a>
								  						<a href="javascript:void(0);" class="wt-deleteinfo"><i class="fal fa-trash-alt"></i></a>
								  					</div>
								  				</div>
								  			...
								  			<li>
								  				<div class="wt-accordioninnertitle">
								  					...
								  					<div class="wt-rightarea">
								  						<a href="javascript:void(0);" class="wt-addinfo wt-skillsaddinfo" id="accordioninnertitlea" data-toggle="collapse" data-target="#innertitlea" aria-expanded="true"><i class="fal fa-pencil"></i></a>
								  						<a href="javascript:void(0);" class="wt-deleteinfo"><i class="fal fa-trash-alt"></i></a>
								  					</div>
								  				</div>
								  			...
								  			<li>
								  				<div class="wt-accordioninnertitle">
								  					...
								  					<div class="wt-rightarea">
								  						<a href="javascript:void(0);" class="wt-addinfo wt-skillsaddinfo" id="accordioninnertitleb" data-toggle="collapse" data-target="#innertitleb" aria-expanded="true"><i class="fal fa-pencil"></i></a>
								  						<a href="javascript:void(0);" class="wt-deleteinfo"><i class="fal fa-trash-alt"></i></a>
								  					</div>
								  				</div>
								  		...
								  		<ul class="wt-experienceaccordion accordion">
								  			<li>
								  				<div class="wt-accordioninnertitle">
								  					...
								  					<div class="wt-rightarea">
								  						<a href="javascript:void(0);" class="wt-addinfo wt-skillsaddinfo" id="accordioninnertitle1" data-toggle="collapse" data-target="#innertitle1" aria-expanded="true"><i class="fal fa-pencil"></i></a>
								  						<a href="javascript:void(0);" class="wt-deleteinfo"><i class="fal fa-trash-alt"></i></a>
								  					</div>
								  				</div>
								  			...
								  			<li>
								  				<div class="wt-accordioninnertitle">
								  					...
								  					<div class="wt-rightarea">
								  						<a href="javascript:void(0);" class="wt-addinfo wt-skillsaddinfo" id="accordioninnertitlea2" data-toggle="collapse" data-target="#innertitlea2" aria-expanded="true"><i class="fal fa-pencil"></i></a>
								  						<a href="javascript:void(0);" class="wt-deleteinfo"><i class="fal fa-trash-alt"></i></a>
								  					</div>
								  				</div>
								  ...
								  <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
								  	<div class="wt-addprojectsholder wt-tabsinfo">
								  		...
								  		<ul class="wt-experienceaccordion accordion">
								  			<li>
								  				<div class="wt-accordioninnertitle">
								  					<div class="wt-projecttitle collapsed" data-bs-toggle="collapse" data-bs-target="#innertitleaone" aria-expanded="false" aria-controls="innertitleaone">
								  					...
								  					<div class="wt-rightarea">
								  						<a href="javascript:void(0);" class="wt-addinfo wt-skillsaddinfo" data-toggle="collapse" data-target="#innertitleaone"><i class="fal fa-pencil"></i></a>
								  						<a href="javascript:void(0);" class="wt-deleteinfo"><i class="fal fa-trash-alt"></i></a>
								  					</div>
								  				</div>
								  				<div class="wt-collapseexp collapse" id="innertitleaone" aria-labelledby="accordioninnertitle" data-bs-parent="#accordion">
								  			...
								  			<li>
								  				<div class="wt-accordioninnertitle">
								  					<div class="wt-projecttitle collapsed" data-bs-toggle="collapse" data-bs-target="#innertitlebone">
								  						<figure><img src="{{asset('assets/images/thumbnail/img-12.jpg')}}" alt="img description"></figure>
								  						<h3>Project Title Here<span>www.themeforest.net</span></h3>
								  					</div>
								  					<div class="wt-rightarea">
								  						<a href="javascript:void(0);" class="wt-addinfo wt-skillsaddinfo" data-bs-toggle="collapse" data-bs-target="#innertitlebone"><i class="fal fa-pencil"></i></a>
								  						<a href="javascript:void(0);" class="wt-deleteinfo"><i class="fal fa-trash-alt"></i></a>
								  					</div>
								  				</div>
								  			...
								  			<li>
								  			<div class="wt-accordioninnertitle">
								  				<div class="wt-projecttitle collapsed" data-bs-toggle="collapse" data-bs-target="#innertitlecone">
								  					<figure><img src="{{asset('assets/images/thumbnail/img-13.jpg')}}" alt="img description"></figure>
								  					<h3>Project Title Here<span>www.themeforest.net</span></h3>
								  				</div>
								  				<div class="wt-rightarea">
								  					<a href="javascript:void(0);" class="wt-addinfo wt-skillsaddinfo" data-bs-toggle="collapse" data-bs-target="#innertitlecone"><i class="fal fa-pencil"></i></a>
								  					<a href="javascript:void(0);" class="wt-deleteinfo"><i class="fal fa-trash-alt"></i></a>
								  				</div>
								  			</div>
								  		...
								  		<ul class="wt-experienceaccordion accordion">
								  			<li>
								  				<div class="wt-accordioninnertitle">
								  					...
								  					<div class="wt-rightarea">
								  						<a href="javascript:void(0);" class="wt-addinfo wt-skillsaddinfo" data-toggle="collapse" data-target="#innertitleawone"><i class="fal fa-pencil"></i></a>
								  						<a href="javascript:void(0);" class="wt-deleteinfo"><i class="fal fa-trash-alt"></i></a>
								  					</div>
								  				</div>
								  			...
								  			<li>
								  				<div class="wt-accordioninnertitle">
								  					...
								  					<div class="wt-rightarea">
								  						<a href="javascript:void(0);" class="wt-addinfo wt-skillsaddinfo" data-toggle="collapse" data-target="#innertitlebwone"><i class="fal fa-pencil"></i></a>
								  						<a href="javascript:void(0);" class="wt-deleteinfo"><i class="fal fa-trash-alt"></i></a>
								  					</div>
								  				</div>
								  			...
								  			<li>
								  				<div class="wt-accordioninnertitle">
								  					...
								  					<div class="wt-rightarea">
								  						<a href="javascript:void(0);" class="wt-addinfo wt-skillsaddinfo" data-toggle="collapse" data-target="#innertitlecwone"><i class="fal fa-pencil"></i></a>
								  						<a href="javascript:void(0);" class="wt-deleteinfo"><i class="fal fa-trash-alt"></i></a>
								  					</div>
								  				</div>
