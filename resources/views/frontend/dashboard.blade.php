						...
						<div class="wt-haslayout wt-dbsectionspace">
							<div class="wt-dashboardbox wt-dashboardtabsholder">
								...
								<div class="wt-dashboardtabs">
									<ul class="wt-tabstitle nav navbar-nav" id="myTab" role="tablist">
										<li class="nav-item">
											<a class="active" data-toggle="tab" id="wt-skills" data-bs-toggle="tab" data-bs-target="#wt-skills" type="button" role="tab" aria-controls="wt-skills" aria-selected="true">Personal Details &amp; Skills</a>
										</li>
										<li class="nav-item"><a data-toggle="tab" id="wt-education" data-bs-toggle="tab" data-bs-target="#wt-education" type="button" role="tab" aria-controls="wt-education" aria-selected="true">Experience &amp; Education</a></li>
										<li class="nav-item"><a data-toggle="tab" href="#wt-awards">Projects &amp; Awards</a></li>
									</ul>
								</div>
								<div class="wt-tabscontent tab-content" id="myTabContent">
									<div class="wt-personalskillshold tab-pane active fade show" role="tabpanel" aria-labelledby="wt-skills" id="wt-skills">
									...
									<div class="wt-educationholder tab-pane fade" role="tabpanel" aria-labelledby="wt-education" id="wt-education">
