    ...
    <div class="row justify-content-md-center">
      <div class="col-xs-12 col-sm-12 col-md-8 push-md-2 col-lg-6 push-lg-3">
        <div class="wt-innerbannercontent">
          <div class="wt-title"><h2>Help & Support</h2></div>
          <ol class="wt-breadcrumb">
            <li><a href="index-2.html">Home</a></li>
            <li class="wt-active">Help & Support</li>
          </ol>
        </div>
      </div>
    </div>
...
<main id="wt-main" class="wt-main wt-haslayout wt-innerbgcolor">
  ...
  <div class="wt-haslayout wt-main-section">
    <div class="wt-contentwrappers">
      <div class="container">
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 float-start">
            <div class="wt-dashboardbox wt-howitwork-hold wt-bgwhite wt-starthiringhold wt-innerspace wt-haslayout">
