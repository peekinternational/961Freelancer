	...
	<div class="container">
		<div class="row d-flex justify-content-center">
          ...
          <div class="login-signup-header border-bottom">
            <h3 class="text-center">Google Register</h3>
            <!-- <p class="text-center">Already have an account? <a href="{{ route('login') }}">Log In</a></p> -->
          </div>
          <div class="login-with-credentials">
            <form action="{{url('google/register')}}" method="POST" id="registerForm"  class="bv-form">
              ...
              @csrf
                ...
                <input type="hidden" name="first_name" value="{{$user->user['given_name']}}">
                <input type="hidden" name="last_name" value="{{$user->user['family_name']}}">
