@if(Auth::user() != '')
  ...
  <div class="alert alert-warning text-black text-center py-1 mb-0" role="alert">Please upload your ID/Passport image to fully verify your account in <strong>24 hours</strong>. click here to verify <a href="{{route('account-setting')}}">Account Setting</a></div>
  @endif
@endif
<header>
